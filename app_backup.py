...
from modules.preprocessing import clean_data, transform_data, normalize_data, visualize_data_structure
...
# === Tambahkan tahap normalisasi ===
        ...
        with tab1:
            ...
            if rows:
                df_original_raw = pd.DataFrame(rows)
                visualize_data_structure(df_original_raw, "Data Asli")
            
            st.write("### 🔄 Data Setelah Preprocessing")
            visualize_data_structure(df_original, "Data Setelah Preprocessing")
